...
class Inference:
    ...
    def users_input(self,):
        print("Enter correct information to predict Rented Bile count for a day with respect to time: ")
        ...
        u_input_list = [hour, temperature, humidity, wind_speed, visibility, \
                        solar_radiation, rainfall, snowfall, holiday_dic[holiday], \
                            finctioning_day[functioning_day], \
...
if __name__ == "__main__":
    ...
    ml_model_path = r"E:\Indian AI Production 4\Projects\ML Projects\001 RG Seoul-Bike-Sharing-Demand-Prediction\models\xgboost_regressor_r2_0_928_v1.pkl"
    standard_scaler_path = r"E:\Indian AI Production 4\Projects\ML Projects\001 RG Seoul-Bike-Sharing-Demand-Prediction\models\sc.pkl"
